...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(department.getDepartmentName()+" biriminde çalışan;\n"+p1.getName()+" "+ p1.getSurname()+" isimli personelin emekli olmasına kalan süre " + p1.retiredTimeMale() + "\n"
                            + p2.getName()+" "+p2.getSurname()+" isimli personelin emekli olmasına kalan süre " +p2.retiredTimeFemale() +"\n"
                            + p3.getName()+" "+p3.getSurname()+" isimli personelin emekli olmasına kalan süre " +p3.retiredTimeMale()+"'dir.");
